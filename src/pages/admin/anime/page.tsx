              ...
              <div className="p-6">
                ...
                <div className="border-t border-purple-200 pt-6 mt-6">
                  <div className="flex items-center justify-between mb-4">
                    <h4 className="text-2xl font-bold bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-600 bg-clip-text text-transparent">
                      Episodes Management
                    </h4>
                  ...
                  {episodesLoading ? (
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-600 text-sm">Loading episodes...</p>
                    </div>
                  ) : animeEpisodes.length === 0 ? (
                    <div className="text-center py-8">
                      <div className="text-gray-400 text-4xl mb-2">📺</div>
                      <p className="text-gray-600 font-medium">No episodes yet</p>
                      <p className="text-gray-500 text-sm">Add the first episode to get started</p>
                    </div>
                  ) : (
                      animeEpisodes.map((episode) => (
                        <div key={episode.id} className="bg-white/80 backdrop-blur-sm rounded-lg p-4 border border-purple-200 shadow-sm hover:shadow-md transition-shadow">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-4">
                              ...
                              <div>
                                <h5 className="text-gray-900 font-semibold text-lg">{episode.title}</h5>
